...
USDT 本质上是稳定币。我更喜欢用一句人话讲清楚：**价格目标接近美元的链上记账单位**。它更多是用来把买币、转账、支付和链上操作这些动作先跑顺。

> TL;DR：很多新手接触加密资产的第一步是先拿到 USDT。原因很现实：在大量交易、支付和链上场景里，USDT 更像“基础结算层”。你可以不喜欢这个名字，但大概率绕不开。
...
**新手第一步常常是 USDT**：大多数币种的交易对以 USDT 计价、转账和支付用稳定币比波动资产更容易理解、新手也倾向先用一个价格稳定的单位把流程跑顺。

在实际工作流里它更常被拿来当中间层。很多人嘴上说想买 BTC，真正动手时，第一步碰到的是 USDT。
