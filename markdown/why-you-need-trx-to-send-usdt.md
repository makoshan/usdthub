...
> TL;DR TRC20 USDT 转账会涉及资源消耗。对新手，最实用的理解不是去背模型，是记住一件事：钱包里只有 USDT，不一定代表这笔转账能顺利发出去。

## 为什么会这样

TRC20 USDT 转账不是单纯的余额移动，而是合约调用的一部分。合约调用要吃资源，所以 TRON 路线里常常会提到 TRX、带宽和能量。

## 新手该怎么处理

- 先知道这是正常现象，不是钱包坏了。
- 第一次转账前，别只看 USDT 余额。
- 如果你主要用 TRC20，顺手理解一下 TRON 能量，后面会省很多事。
